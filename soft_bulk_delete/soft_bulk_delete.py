...
search_url = "https://pagopa.zendesk.com/api/v2/search.json?" + urlencode(
    search_params
)
...
print(
    "Found "
    + str(len(ticket_ids))
    + " tickets to be deleted (closed BEFORE "
    + date_limit_s
    + ")."
)
...
for tickets in list(chunks(ticket_ids, 100)):
    ...
    soft_destroy_url = (
        "https://pagopa.zendesk.com/api/v2/tickets/destroy_many.json?"
